...
use read_data_files::{read_dept_data_file,read_emp_data_file,read_leave_data_file,read_salary_data_file,get_empid_dept_id_pair};
...
pub fn get_final_report(app_name:&str) -> HashMap<String,final_report> {
 ...
 pub fn write_summary(app_name:&str){
    let mut mapoffinalreport:HashMap<String, final_report >=HashMap::new();
